...
import { Heart, Clock, Lock, Infinity as InfinityIcon, PenTool, Feather, Sparkles, MessageCircleHeart, MessageSquareQuote } from 'lucide-react';
...
export function SceneHub({ onConfession, onCountdown, onForever, onLetter, onTimeline, onMessage, onAnswers, onLovenama }: SceneHubProps) {
