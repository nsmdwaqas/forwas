...
export function SceneHub({ onConfession, onCountdown, onForever }: SceneHubProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-sm mx-auto text-center px-4">
      <motion.div 
        className="glass-panel w-full p-8 md:p-12 relative overflow-hidden flex flex-col gap-6"
        whileHover={{ rotateX: 2, rotateY: -2 }}
        transition={{ type: "spring", stiffness: 100, damping: 30 }}
      >
        <motion.h1 
          className="text-3xl md:text-4xl font-heading mb-4 text-white text-shadow-elegant shimmer-text"
